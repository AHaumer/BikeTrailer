...
model TestTrailerWithoutDrive "Test the trailer without drive"
  ...
  Modelica.Blocks.Sources.CombiTimeTable track(table = [0, 0, 0, 0; 60, 25, 0, 0; 120, 25, -5, 0; 120, 25, -5, 0.1; 180, 20, 0, 0.1; 180, 20, 0, -0.1; 240, 30, 5, -0.1; 240, 30, 5, 0; 300, 25, 0, 0; 360, 0, 0, 0; 420, 0, 0, 0], extrapolation = Modelica.Blocks.Types.Extrapolation.HoldLastPoint) annotation (
...
equation
  ...
  connect(track.y[1], from_kmh.u) annotation (
    Line(points = {{-69, 0}, {-52, 0}}, color = {0, 0, 127}));
  connect(bike.flange, trailer.flange) annotation (
    Line(points = {{0, 0}, {10, 0}}, color = {0, 127, 0}));
  connect(track.y[2], trailer.vWind) annotation (
    Line(points = {{-69, 0}, {-60, 0}, {-60, -20}, {14, -20}, {14, -12}}, color = {0, 0, 127}));
  connect(track.y[3], trailer.inclination) annotation (
    Line(points = {{-69, 0}, {-60, 0}, {-60, -20}, {26, -20}, {26, -12}}, color = {0, 0, 127}));
  connect(tauRef.y, trailer.tauRef) annotation (
    Line(points={{31,30},{40,30},{40,0},{30,0}},
                                      color = {0, 0, 127}));
  annotation (
    experiment(StopTime = 420, Interval = 0.001),
